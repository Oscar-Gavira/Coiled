...
int Entrada_StdIn();																/* Comprobamos entradas durante la búsqueda. */
int ValorPieza(int Pieza);															/* Obtenemos el valor de la pieza */
int Es_Numero(char *p);																/* Comprueba si una cadena es numérica (sin decimales, para los parámetros UCI) */
int Es_Un_Numero(char c);															/* Verifica si es un numérico */
