...
int load_egbb_xxx(char* path,int cache_size,int load_options) {
    EGBB* pegbb[2];
    ENUMERATOR* penum;
...
x men
*/
DLLExport int _CDECL load_egbb_xmen(char* path,int cache_size,int load_options) {
        return load_egbb_xxx(path,cache_size,load_options);
}
